...
<html lang="en">
    <head>
        ...
        <script language="javascript" src="includes/tabloid_prices.js"></script>
        <style type="text/css">
...
<body>
        <div id="content">            
            <p align="center" class="body-text"><span class="heading">Tabloid Newspapers</span></p>
            ...
            <div id="tables">
                <form id="x700">
                    <table id="price_table_2">
                        <tr>
                            ...
                            <td class="right_cells">
                                <select id="type" onChange="update_price()">
                                    ...
                                    <option value="WhiteOffset">White Offset</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="bottom_cells">Color Pages:</td>
...
-->
        ...
        function color_box() {
            $colorOptions = [
                "None" => 0,
                "Front, Back Centerforld (4 pages)" => 250,
                "Front, Back Centerforld (8 pages)" => 375,
                "Front and Back only (2 pages)" => 250,
            ];
            $colorKeys = array_keys($colorOptions);

            $color = "";
            for ($i = 0; $i < count($colorOptions); $i += 1) {
                $colorText = $colorKeys[$i];
                $colorPrice = $colorOptions[$colorText];
                $color .= "<option value=" . $colorPrice . ">$colorText</option>";
            }
        ...
        <table width="500" border="1" align="center">
          <tr>
            <td colspan="2"><h3>Full Color Printing Charges</h3>
            <p>The prices above are for black ink only. If you want color simply add the appropriate value 
              from the 
            chart below to your total from the calculator above.</p></td>
          </tr>
          <tr>
            <td width="460">Front, Back, and Centerfold (4 pages)</td>
            <td width="324">$250</td>
          </tr>
          <tr>
            <td>Front, Back, and Centerfold (8 pages)</td>
            <td>$375</td>
          </tr>
          <tr>
            <td>Front and Back only (2 pages)</td>
            <td>$250</td>
          </tr>
          <tr>
            <td>Centerfold only (2 pages)</td>
            <td>$250</td>
          </tr>
          <tr>
